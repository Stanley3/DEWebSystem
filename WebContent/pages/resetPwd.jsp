...
<body>
	...
	<div id="header">
		...
		<div class="col w5 last right bottomlast">
			<p class="last">
				当前用户： <span class="strong"><%=name %></span> <a href="resetPwd.jsp">修改密码</a>
						...
						<table>
							<tr>
								...
								<td><input class="easyui-textbox" id="oldPwd" name="oldPwd"
									style="width:200px;heigth=32px" type="password" /> <%=tips%></td>
							</tr>
							<tr>
								<td><label for="newPwd">请输入新密码：</label></td>
								<td><input class="easyui-textbox" id="newPwd" name="newPwd"
									style="width:200px;heigth=32px" type="password" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2"><input class="easyui-linkbutton"
									...
									onclick="goBack()" style="height:32px;width:80px" /></td>
							</tr>
						</table>
					</form>
				</div>
