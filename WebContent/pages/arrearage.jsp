...
<title>欠费管理-驾驶员培训科目三模拟考试系统管理后台</title>
...
<body>
	<div id="header">
		<div class="col w5 bottomlast">
			<a href="" class="logo"> <img src="../resources/template/images/logo.gif" alt="Logo" />
			</a>
		</div>
			...
			<div id="holder">
				<div id="menu">
					...
					<ul>
						...
						<li><a href="arrearage.jsp" class="selected"><span>欠费管理</span></a></li>
